...
bool path_contains_file(std::filesystem::path dir, std::filesystem::path file)
{
...
int main()
{
	std::filesystem::path path = "/you/me/stuff/exe/";
	std::filesystem::path path1 = "/you/me/stuff/exe/fine/4";
	std::filesystem::path path2 = "/you/me/stuff/fine";

	std::cout << path_contains_file(path, path1) << " " << path_contains_file(path, path2);
